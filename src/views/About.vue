...
import Newsletter from ".././components/about/Newsletter.vue";
...
<template>
  <div id="animatedContainer" class="my-4 max-w-6xl xl:px-16 grid gap-1 sm:grid-cols-6 lg:grid-cols-9">
    <About
      class="w-full col-span-full lg:col-span-6 h-[55vh] animate-fade-in"
      data-animation-order="1"
    />
    <Hero
      class="w-full col-span-full lg:col-span-3 h-[55vh] hidden lg:block animate-fade-in delay-100"
    ...
    />
    <Newsletter
      class="w-full sm:col-span-full lg:col-span-4 min-h-[26vh] animate-fade-in delay-400"
